...
import 'package:lakuseni_user/update_cost_page.dart';
...
class SellerOrderPerformancePage extends StatefulWidget {
  SellerOrderPerformancePage({Key? key, required this.order}) : super(key: key);
  Order order;
  @override
  State<SellerOrderPerformancePage> createState() =>
      _SellerOrderPerformancePageState();
}

class _SellerOrderPerformancePageState
    extends State<SellerOrderPerformancePage> {
